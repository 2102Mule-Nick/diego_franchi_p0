...
public class ConnectionFactoryPostgres {
	...
	private ConnectionFactoryPostgres() {
		...
		DB_NAME = System.getenv("DATE_DB_NAME");
		
		URL = "jdbc:postgresql://" + System.getenv("DATE_DB_URL") + ":5432/" + DB_NAME + "?currentSchema=" + System.getenv("DATE_DB_SCHEMA");

		USERNAME = System.getenv("DATE_DB_USERNAME");

		PASSWORD = System.getenv("DATE_DB_PASSWORD");
	}
